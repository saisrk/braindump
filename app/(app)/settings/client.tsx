...
import { LogOut, Sun, Moon, Trash2, ChevronDown } from 'lucide-react';
...
export function SettingsClient({ initialSettings }: { initialSettings: UserPreferences }) {
            ...
            <div className="divide-y divide-border">
              ...
              <div className="flex items-center justify-between py-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-0.5">
                    {digestEnabled
                      ? 'Email digest sent each morning with due reviews'
                      : 'Get notified about due reviews by email'}
                  </p>
                </div>
              ...
              <div className="py-4">
                <div className="flex items-center justify-between mb-3">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-0.5">Permanently remove your account and all data. This cannot be undone.</p>
                  </div>
                </div>
                <button
      ...
      {showDeleteModal && (
        ...
        >
          <div style={{ background: 'var(--color-card)', borderRadius: '16px', border: '1px solid var(--color-border)', padding: '28px', maxWidth: '420px', width: '100%', boxShadow: '0 24px 48px -12px rgba(42,38,32,0.4)' }}>
            ...
            <h3 style={{ fontFamily: "'Spectral', Georgia, serif", fontWeight: 700, fontSize: '20px', color: 'var(--color-foreground)', marginBottom: '10px' }}>
              Delete your account?
            </h3>
